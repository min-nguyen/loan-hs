...
/* package Oneiro-0.1.0.0 */
#ifndef VERSION_Oneiro
#define VERSION_Oneiro "0.1.0.0"
#endif /* VERSION_Oneiro */
#ifndef MIN_VERSION_Oneiro
#define MIN_VERSION_Oneiro(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Oneiro */
...
#define CURRENT_COMPONENT_ID "Oneiro-0.1.0.0-inplace-Oneiro"
